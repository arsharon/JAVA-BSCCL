 ...
 */
public class SuppDashController implements Initializable {

    @FXML
    private Menu suppHome;
    @FXML
    private MenuItem suppPerformance;
    @FXML
    private MenuItem suppBid;
    @FXML
    private MenuItem suppTender;
    @FXML
    private MenuItem suppSupport;
    @FXML
    private MenuItem suppProfile;
    @FXML
    private TextArea dashtext;
    @FXML
    private ImageView dashimage;
    @FXML
    private MenuItem suppCheck;
    @FXML
...
"The Bangladesh Submarine Cable Company signed the agreement with SMW-5 Consortium in 2014 \n and ensures the ownership of the country's second submarine \n cable, which on 10th September-2017, Honorable Prime Minister of Bangladesh, Sheikh Hasina inaugurated the \n SEA-ME-WE-5 cable system through video conferencing.");
    ...
    @FXML
    private void suppPerformanceOnaction(ActionEvent event) throws IOException {
        Parent root = FXMLLoader.load(getClass().getResource("suppWork.fxml"));
    ...
    @FXML
    private void suppBidOnaction(ActionEvent event) throws IOException {
        Parent root = FXMLLoader.load(getClass().getResource("suppBid.fxml"));
    ...
    @FXML
    private void suppTenderOnaction(ActionEvent event) throws IOException {
        Parent root = FXMLLoader.load(getClass().getResource("suppTender.fxml"));
    ...
    @FXML
    private void suppSupportOnaction(ActionEvent event) throws IOException {
        Parent root = FXMLLoader.load(getClass().getResource("suppSupport.fxml"));
    ...
    @FXML
    private void suppProfileOnaction(ActionEvent event) throws IOException {
        Parent root = FXMLLoader.load(getClass().getResource("suppProfile.fxml"));
    ...
    @FXML
    private void suppCheckOnaction(ActionEvent event) throws IOException {
        Parent root = FXMLLoader.load(getClass().getResource("suppCheck.fxml"));
