 ...
 */
public class CusDashController implements Initializable {

    @FXML
    private Menu cusHome;
    @FXML
    private MenuItem cusCheck;
    @FXML
    private MenuItem cusComm;
    @FXML
    private MenuItem cusForm;
    @FXML
    private MenuItem cusSupport;
    @FXML
    private MenuItem cusProfile;
    @FXML
...
"The Bangladesh Submarine Cable Company signed the agreement with SMW-5 Consortium in 2014 \n and ensures the ownership of the country's second submarine \n cable, which on 10th September-2017, Honorable Prime Minister of Bangladesh, Sheikh Hasina inaugurated the \n SEA-ME-WE-5 cable system through video conferencing.");
    ...
    @FXML
    private void cusCheckOnaction(ActionEvent event) throws IOException {
        Parent root = FXMLLoader.load(getClass().getResource("customerCheck.fxml"));
    ...
    @FXML
    private void cusCommOnaction(ActionEvent event) throws IOException {
        Parent root = FXMLLoader.load(getClass().getResource("customerComAdmin.fxml"));
    ...
    @FXML
    private void cusFormOnaction(ActionEvent event) throws IOException {
        Parent root = FXMLLoader.load(getClass().getResource("cusForm.fxml"));
    ...
    @FXML
    private void cusSupportOnaction(ActionEvent event) throws IOException {
        Parent root = FXMLLoader.load(getClass().getResource("cusSupport.fxml"));
    ...
    @FXML
    private void cusProfileOnaction(ActionEvent event) throws IOException {
        Parent root = FXMLLoader.load(getClass().getResource("cusProfile.fxml"));
    ...
    @FXML
    private void packagesOnaction(ActionEvent event) throws IOException {
        Parent root = FXMLLoader.load(getClass().getResource("cusPackages.fxml"));
