 ...
 */
public class MinistryDashboardController implements Initializable {

    @FXML
    private Menu minHome;
    @FXML
    private MenuItem minInfo;
    @FXML
    private MenuItem minTrack;
    @FXML
    private MenuItem minCheck;
    @FXML
    private MenuItem minCom;
    @FXML
...
"The Bangladesh Submarine Cable Company signed the agreement with SMW-5 Consortium in 2014 \n and ensures the ownership of the country's second submarine \n cable, which on 10th September-2017, Honorable Prime Minister of Bangladesh, Sheikh Hasina inaugurated the \n SEA-ME-WE-5 cable system through video conferencing.");
    ...
    @FXML
    private void minInfoOnclick(ActionEvent event) throws IOException {
        Parent root = FXMLLoader.load(getClass().getResource("minInfo.fxml"));
    ...
    @FXML
    private void minTrackOnclick(ActionEvent event) throws IOException {
        Parent root = FXMLLoader.load(getClass().getResource("minViewWork.fxml"));
    ...
    @FXML
    private void minCheckOnclick(ActionEvent event) throws IOException {
        Parent root = FXMLLoader.load(getClass().getResource("minCheck.fxml"));
    ...
    @FXML
    private void minComOnclick(ActionEvent event) throws IOException {
        Parent root = FXMLLoader.load(getClass().getResource("minComAdmin.fxml"));
