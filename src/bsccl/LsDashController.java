 ...
 */
public class LsDashController implements Initializable {
...
"The Bangladesh Submarine Cable Company signed the agreement with SMW-5 Consortium in 2014 \n and ensures the ownership of the country's second submarine \n cable, which on 10th September-2017, Honorable Prime Minister of Bangladesh, Sheikh Hasina inaugurated the \n SEA-ME-WE-5 cable system through video conferencing.");
    ...
    @FXML
    private void infoOnclick(ActionEvent event) throws IOException {
        Parent root = FXMLLoader.load(getClass().getResource("lsUpdate.fxml"));
    ...
    @FXML
    private void comWithAdminOnclick(ActionEvent event) throws IOException {
        Parent root = FXMLLoader.load(getClass().getResource("lsCom.fxml"));
    ...
    private void noticeOnclick(ActionEvent event) throws IOException {
        Parent root = FXMLLoader.load(getClass().getResource("lsNotice.fxml"));
    ...
    @FXML
    private void finInfoOnclick(ActionEvent event) throws IOException {
        Parent root = FXMLLoader.load(getClass().getResource("lsFinancial.fxml"));
